...
<meta charset="UTF-8">
  <title>약관 동의</title>
   ...
   <style>
       ...
       h2 { margin:200px 150px 100px 150px; }
       form { margin-bottom:250px; }
      .form_fr { margin:20px; height:20; text-align:center}
      .btn_area {margin:0 auto;height:100px; width:100%;}
      .btn_wrap {width:25%; height:100%; margin:0 auto; }
      .btns {
...
8.회원의 개인정보 이용에 대한 동의는 회원이 본 약관에 동의(2조4항에따른 동의로 보는 경우 포함)하는 것으로서 갈음합니다.
 ...
 <div class="btn_area">
 	<div class="btn_wrap">
 	<input type ="submit" value="회원가입" class="btns"/>
