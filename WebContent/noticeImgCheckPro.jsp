...
<%
		...
		try {  
			...
			//파일 경로를 수정하세요
			String saveDirectory = "D:\\ssj\\jsp\\project1\\WebContent\\img";
			...
			originalFile = multi.getOriginalFileName("n_pic");
			uploadFile = multi.getFilesystemName("n_pic");
...
%>
		...
		function apply(id){
			...
			//opener.document.getElementById("n_img").src = id;
			//opener.document.joinform.n_img.readonly=true;
